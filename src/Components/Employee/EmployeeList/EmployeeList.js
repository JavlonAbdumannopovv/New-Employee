...
function EmployeeList(props) {
  ...
  let listItems = props.items.slice(0, listLength).map((item) => {
      return (
        <li key={item.name + item.department} name={item.name + item.department + "item"}>
          ...
          <div className="list_actions">
            <i className='bx bx-pencil' onClick={editItem} name={item.name + item.department + "Editor"}></i>
            <i className='bx bx-x' onClick={deleteItem} name={item.name + item.department + "delete"}></i>
          </div>
        </li>
      )
})
  ...
  <div className="employee_list">
    <ul className="list">
      ...
      <div className="list_footer">
        <p>Rows per page:
          <span className="rowBtn active" onClick={listLengthHanler}>5</span>
          <span className="rowBtn" onClick={listLengthHanler}>10</span>
          <span className="rowBtn" onClick={listLengthHanler}>20</span>
        </p>
      </div>
    </ul>
  </div>
